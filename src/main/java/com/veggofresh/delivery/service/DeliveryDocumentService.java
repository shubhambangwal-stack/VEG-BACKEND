...
public interface DeliveryDocumentService {
    /** Returns application details including all 4 document types for this partner, auto-creating PENDING rows for any missing type. */
    DeliveryApplicationDetailsResponseDto getDocuments(UUID userId);
